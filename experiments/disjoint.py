...
tiers = [JaCovTier(train_loader, range=[60, 70]),
         TrainingSpeedEstimateTier(dataset_api, config, range=[70, 80]),
         QueryFullTrainingTier(config.dataset, dataset_api, range=[80, 100])]
